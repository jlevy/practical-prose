...
(function () {
  ...
  const groupsById = Object.freeze(
    Object.fromEntries(designSystem.groups.map((g) => [g.id, g])),
  );
  const dimensionsById = Object.freeze(
    Object.fromEntries(designSystem.dimensions.map((d) => [d.id, d])),
  );
  const scoresByLevel = Object.freeze(
    Object.fromEntries(designSystem.scores.map((s) => [s.level, s])),
  );
  globalThis.PracticalProseDesignSystem = Object.freeze({
    designSystem,
    groupsById,
    dimensionsById,
    scoresByLevel,
