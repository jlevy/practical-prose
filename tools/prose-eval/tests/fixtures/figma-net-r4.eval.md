...
**Source:** `<external artifact not in this repo>`  **Scope:** `—`  **Overall mean (18 dims):** 4.70  **Rubric:** `18-dim-v1-stale-baseline`  **Model:** `—`  **Eval date:** 2026-05-07
