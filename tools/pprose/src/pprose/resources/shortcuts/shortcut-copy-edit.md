...
1. Read `pprose guidelines common-doc-guidelines` fully.
...
2. Read the Expression and Form dimensions of
   `pprose guidelines practical-prose-guidelines` (§Expression
...
3. Read `pprose guidelines ai-prose-corrections`, the binding catalog
