...
The companion `pprose guidelines practical-prose-rubric` can be used to
...
`pprose guidelines practical-prose-rubric` provides the descriptive 1-5
...
Cascades* in `pprose guidelines practical-prose-rubric`).
...
`pprose guidelines practical-prose-rubric` defines the four passes, the
