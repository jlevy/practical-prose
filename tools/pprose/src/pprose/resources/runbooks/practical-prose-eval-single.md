...
`pprose guidelines practical-prose-rubric` (anchors per dimension,
...
- **Input:** one Markdown artifact, the rubric
  (`pprose guidelines practical-prose-rubric`), and the prescriptive
  guidelines (`pprose guidelines practical-prose-guidelines`).
...
[agents-internal-guide.md](https://github.com/jlevy/practical-prose/blob/main/docs/project/agents-internal-guide.md) §Tooling; batch
