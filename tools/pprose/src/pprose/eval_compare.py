...
Output shape (unified mode):
  ...
  - Rows are grouped by rubric category (Purpose, Expression, Form, Reasoning,
    Grounding, Judgment) and follow rubric-schema dimension order. Each category section runs
