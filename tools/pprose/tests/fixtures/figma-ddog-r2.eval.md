...
**Source:** `<external artifact not in this repo>`  **Scope:** `—`  **Overall mean (20 dims):** 3.83  **Rubric:** `pp20v2`  **Model:** `—`  **Eval date:** 2026-05-07
...
|  | Factuality | 4 |  |
|  | Relevance | ERR | Applicable but unassessable in this rebaseline pass; not scored in r2 round. |
|  | **Mean** | **4.00** | |
| **Reasoning** | Discipline | ERR |  |
|  | Soundness | ERR |  |
|  | Precision | ERR |  |
|  | Parsimony | ERR | Applicable but unassessable in this rebaseline pass; not scored in r2 round. |
|  | **Mean** | — | |
