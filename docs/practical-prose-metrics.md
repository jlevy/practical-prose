...
| 14 | Discipline | Rung-tag count (`[observed]`, `[judged]`, `[interpreted]`, `[implied]`) in audit/eval modes; multi-rung-per-sentence flag | Are observation, judgment, interpretation, implication kept distinct? | metrics.py bracket tags (audit mode); LLM-assist; manual |
