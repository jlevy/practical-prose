...
source: "2025 Instructions for Form 1040 and 1040-SR"
source_url: "https://www.irs.gov/instructions/i1040gi"
license_note: "IRS-authored U.S. federal government material; icons and page chrome are omitted from this text fixture."
retrieved: "2026-05-13"
selection_note: "Official full-text HTML section selected as a high-stakes, rule-heavy, mixed-usability baseline."
conversion_note: "Converted from the IRS full-text HTML instructions; icon callouts were normalized as Tip/Caution blockquotes and filing charts were converted to Markdown tables/lists."
---
...
Use Chart A, B, or C to see if you must file a return. U.S. citizens who lived in or had income from a U.S. territory should see Pub. 570. Residents of Puerto Rico can use [Tax Topic 901](https://www.irs.gov/taxtopics/tc901.html) to see if they must file.
...
> Tip: See Pub. 501 for details. Also, see Pub. 501 if you do not have to file but received a Form 1099-B or 1099-DA (or substitute statement).
...
You must attach Form 8962 even if someone else enrolled you, your spouse, or your dependent. If you are a dependent who is claimed on someone else's 2025 return, you do not have to attach Form 8962.

### Exception for certain children under age 19 or full-time students

If certain conditions apply, you can elect to include on your return the income of a child who was under age 19 at the end of 2025 or was a full-time student under age 24 at the end of 2025. To do so, use Form 8814. If you make this election, your child doesn't have to file a return. For details, use [Tax Topic 553](https://www.irs.gov/taxtopics/tc553.html) or see Form 8814.

A child born on January 1, 2002, is considered to be age 24 at the end of 2025. Do not use Form 8814 for such a child.

### Resident aliens

These rules also apply if you were a resident alien. Also, you may qualify for certain tax treaty benefits. Generally, you are a resident alien if you meet either the green card test or the substantial presence test for 2025. See Pub. 519 for details.
...
> Tip: The chart at the end of these instructions provides the current address for mailing your return. Use these addresses for Form 1040 or 1040-SR filed in 2026. The address for returns filed after 2026 may be different. See [IRS.gov/Form1040](https://www.irs.gov/form1040) for any updates.
...
To check for any updates to the list of designated private delivery services, go to [IRS.gov/PDS](https://www.irs.gov/privatedeliveryservices). For the IRS mailing address to use if you're using a private delivery service, go to [IRS.gov/PDSStreetAddresses](https://www.irs.gov/uac/submission-processing-center-street-addresses-for-private-delivery-service-pds).
...
**Gross income** means all income you received in the form of money, goods, property, and services that isn't exempt from tax, including any income from sources outside the United States or from the sale of your main home, even if you can exclude part or all of it. Don't include any social security benefits unless one of the following applies.

- You are married filing a separate return and you lived with your spouse at any time in 2025.
- One-half of your social security benefits plus your other gross income and any tax-exempt interest is more than $25,000, or $32,000 if married filing jointly.

If either applies, see the instructions for lines 6a and 6b to figure the taxable part of social security benefits you must include in gross income. Gross income includes gains, but not losses, reported on Form 8949 or Schedule D. Gross income from a business means, for example, the amount on Schedule C, line 7, or Schedule F, line 9. But, in figuring gross income, don't reduce your income by any losses, including any loss on Schedule C, line 7, or Schedule F, line 9.
...
- Your unearned income was over $3,350, or $5,350 if 65 or older and blind.
- Your earned income was over $17,750, or $19,750 if 65 or older and blind.
- Your gross income was more than the larger of:
  - $3,350, or $5,350 if 65 or older and blind, or
  - your earned income, up to $15,300, plus $2,450, or $4,450 if 65 or older and blind.
...
- Your unearned income was over $2,950, or $4,550 if 65 or older and blind.
- Your earned income was over $17,350, or $18,950 if 65 or older and blind.
- Your gross income was at least $5 and your spouse files a separate return and itemizes deductions.
- Your gross income was more than the larger of:
  - $2,950, or $4,550 if 65 or older and blind, or
  - your earned income, up to $15,300, plus $2,050, or $3,650 if 65 or older and blind.
